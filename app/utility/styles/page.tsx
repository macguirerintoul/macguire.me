...
export default function Styles() {
	return (
		<>
			...
			<hr />
			<h2>a</h2>
			<Link href="/about">Lorem Ipsum</Link>
			<h2>address</h2>
			<address>
			...
			<hr />
			<p>
				<Link href="/about">Lorem Ipsum</Link> is simply dummy text{" "}
				<kbd>of</kbd> the printing and typesetting <code>industry</code>. Lorem
			...
			<p>
				Ashok&apos;s joke made me <abbr title="Laugh Out Loud">LOL</abbr> big
				time.
			</p>
			<figure>
				<blockquote>
