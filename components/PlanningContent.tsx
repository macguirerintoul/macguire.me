"use client"; // react-medium-image-zoom
...
const PlanningContent = () => {
	return (
		<>
			...
			<Image src={dialogs} alt="dialogs" placeholder="blur" className="my-8" />
			<section>
			...
			<section>
				...
				<Image src={rollup} className="my-8" alt="rollup" placeholder="blur" />
			</section>
			<section>
				<h2>Help</h2>
				<p>
				...
				<Image src={help} className="my-8" alt="help" placeholder="blur" />
				<Image src={disthelp} className="my-8" alt="help" placeholder="blur" />
			</section>
			<section>
				<h2>Conclusion</h2>
				<p>
