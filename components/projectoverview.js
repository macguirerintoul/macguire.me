	...
	return (
		<section className="overview">
			<div className="overview__main">
				<div className="overview__header" >{ props.project.title } ✦ { props.project.year } ✦
					{props.project.tags.map(tag => {
						return <Tag key={tag}> { tag }</Tag>
					} )}
				</div>
				
				<p className="overview__summary" dangerouslySetInnerHTML={{__html:props.project.summary}} />
				<MagicImage
